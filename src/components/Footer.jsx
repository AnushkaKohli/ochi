...
const Footer = () => {
  const MLinks = [
    ...
    {
      name: "Services",
      url: "https://ochi.design/services/",
    },
    {
      name: "Our work",
      url: "https://ochi.design/presentations/",
    },
    {
      name: "About us",
      url: "https://ochi.design/ochi-team/",
    },
    {
      name: "Insights",
      url: "https://ochi.design/insights/",
    },
    {
      name: "Contact us",
      url: "https://ochi.design/contact/",
    },
  ];
  const SLinks = [
    {
  ...
  const ELinks = [
    {
      name: "hello@ochi.design",
      url: "mailto:http://hello@ochi.design",
    },
  ];
  return (
    <footer className="footer relative bg-[#f1f1f1] h-full -mb-8">
      ...
      <div className="container px-[4vw]">
        {/* Footer top */}
        <div className="grid md:grid-cols-12 md:gap-y-5 mb-20">
          {/* Eye opening presentations */}
          <div className="md:col-span-5 xl:col-span-6">
            <h1 className="uppercase text-[8.5vw] font-foundersgrotesk leading-[8.7vw] tracking-tight block text-start overflow-hidden">
              Eye-
            </h1>
            <h1 className="uppercase text-[8.5vw] font-foundersgrotesk leading-[8.7vw] tracking-tight block text-start overflow-hidden">
              opening
          ...
          <div className="md:col-span-7 xl:col-span-6">
            ...
            <div className="grid grid-cols-2 gap-8">
              {/* MLinks */}
              <div className="md:order-last md:flex md:flex-col md:justify-end">
                <p className="mb-3">M:</p>
                <ul>
                  {MLinks.map((item, index) => {
                    return (
              ...
              <div className="grid gap-10 col-span-2 md:col-span-1">
                <div>
                  ...
                  <ul>
                    {LLinks.map((item, index) => {
                      return (
                        <li key={index} className="underline-container">
                          <span className="underline-animation text-lg cursor-pointer">
                            {item}
                          </span>
                        </li>
                      );
        ...
        {/* Footer bottom */}
        <div className="grid md:grid-cols-12 md:gap-y-5 mb-20 md:items-end">
          <div className="mb-20 md:mb-0 md:col-span-5 lg:col-span-6">
            <a className="inline-flex" href="https://ochi.design">
              <svg
                width="72"
                height="30"
                viewBox="0 0 72 30"
          ...
          <div className="opacity-30 md:col-span-4">
          ...
          <div className="md:text-right opacity-30 md:col-span-3 lg:col-span-2">
            <span className="underline-animation cursor-pointer">
              Website made by Anushka
            </span>
          </div>
        </div>
      </div>
